...
const DICT: Record<string, { en: string; fr: string }> = {
  ...
  'admin.signInTitle': { en: 'Scoring sign in', fr: 'Connexion au scoring' },
  ...
  'admin.restricted': { en: 'Sign in with the scoring account for this event.', fr: 'Connectez-vous avec le compte de scoring de cet événement.' },
  'admin.cloudUnavailable': { en: 'Cloud backend not configured — local scoring mode is active.', fr: 'Backend cloud non configuré — le mode de scoring local est actif.' },
  ...
  "scoringStation.title": { en: "Scoring station", fr: "Poste de scoring" },
  "scoringStation.targetTitle": { en: "Target {number}", fr: "Cible {number}" },
  "scoringStation.chooseTarget": { en: "Choose your target", fr: "Choisissez votre cible" },
  "scoringStation.chooseTargetHelp": { en: "The matches assigned by the tournament manager will appear here automatically.", fr: "Les matchs attribués par le gestionnaire du tournoi apparaîtront ici automatiquement." },
  "scoringStation.targetNumber": { en: "Target number", fr: "Numéro de la cible" },
  "scoringStation.targetPlaceholder": { en: "e.g. 4", fr: "ex. 4" },
  "scoringStation.openTarget": { en: "Open this target", fr: "Ouvrir cette cible" },
  "scoringStation.changeTarget": { en: "Change target", fr: "Changer de cible" },
  "scoringStation.stationReady": { en: "This station is set to target {number}", fr: "Ce poste est réglé sur la cible {number}" },
  ...
  "scoringStation.noAssignedMatches": { en: "No match assigned to this target", fr: "Aucun match attribué à cette cible" },
  ...
  "scoringStation.noPendingMatches": { en: "There are no more matches to play on this target.", fr: "Il n’y a plus de match à jouer sur cette cible." },
  "scoringStation.finishedMatches": { en: "Finished on this target", fr: "Terminés sur cette cible" },
  ...
  "premierLeague.chooseStarter": { en: "Who starts leg 1?", fr: "Qui commence le premier leg ?" },
  "premierLeague.starterAlternates": { en: "The first throw alternates automatically on every new leg.", fr: "Le joueur qui commence alterne automatiquement à chaque nouveau leg." },
  ...
  "premierLeague.matchFinishedSaving": { en: "Match finished — saving before returning to the target…", fr: "Match terminé — enregistrement avant le retour à la cible…" },
  ...
  "premierLeague.admin.correctMessage": { en: "The winning visit will be removed and every dependent bracket and standing will be recalculated. This is blocked if the next dependent match has started.", fr: "La visite gagnante sera retirée et le tableau ainsi que le classement seront recalculés. L’action est bloquée si le match dépendant suivant a commencé." },
  ...
  "premierLeague.admin.bracketHelp": { en: "Quarter-finals may be rearranged before play. Once a Night starts, an explicit organizer confirmation is required and started fixtures remain protected.", fr: "Les quarts peuvent être réorganisés avant le début. Une fois la Night commencée, une confirmation organisateur explicite est requise et les matchs commencés restent protégés." },
  ...
  "premierLeague.admin.lockedMessage": { en: "At least one match has started. Only untouched fixtures can still be changed. Confirm this organizer override?", fr: "Au moins un match a commencé. Seuls les matchs non démarrés peuvent encore changer. Confirmer cette dérogation organisateur ?" },
